...
// import './DefaultAside'
import background_img from '../images/banner-bg.png'
  ...
  render() {
    return (
      <Card style={{backgroundImage:`url(${background_img})`,width:"100%",height:"100%",margin:"0"}}>
        <div className="container p-3" style={{margin:"auto",marginTop:"200px", border:"1px solid black", backgroundColor:"white"}}>
         ...
         <p className="text-center"
              style={{color: "#493085", fontSize: "3rem"}}>
              <b>TSSN BANK</b>
          </p>
      </div>
      ...
      <FormGroup row>
         ...
         <Col md="8">
             <Input type="email" name="userName" placeholder="Please Enter Email" onChange={this.onChange}></Input>
         </Col>
      </FormGroup>
      <FormGroup row>
         <Col md="4">
         ...
         <Col md="8">
             <Input type="email" name="password" placeholder="Please Enter Password" onChange={this.onChange}></Input>
         </Col>
      </FormGroup>
      <FormGroup style={{textAlign:"center"}}>
           ...
           <Button type="submit" size="sm"  style={{marginTop:"5%",marginLeft:"2%",backgroundColor:"red"}}   onClick={(e)=>this.handleRegistraton()}>Registration</Button>
       </FormGroup>
